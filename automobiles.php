...
<html>
	<head>
		<title>daShop|Automobiles</title>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$("#results" ).load( "automobiles/product.php"); //load initial records
				...
				$("#results").on( "click", ".pagination a", function (e){
					...
					$("#results").load("automobiles/product.php",{"page":page}, function(){ //get content from PHP page
	...
	<body id="automobiles">
		...
		<section class="middle_container"
			...
			<div id="category_items">
				<?php include("automobiles/sidenav.php");?>
				<?php include("automobiles/ordernav.php");?>
