...
<html>
	<head>
		<title>admin@qRide|Products</title>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$("#results" ).load( "admin@dashop/products.php"); //load initial records
				...
				$("#results").on( "click", ".pagination a", function (e){
					...
					$("#results").load("admin@dashop/products.php",{"page":page}, function(){ //get content from PHP page
	...
	<head>
	<body id="adminproducts">
		<div id="main1">
			<?php include("admin@dashop/admindashboard.php");?>
			<div id="main_container">
				<?php include("admin@dashop/adminproducts.php");?>
