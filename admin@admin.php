	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$("#data" ).load( "admin@dashop/home.php"); //load initial records
				...
				$("#data").on( "click", ".pagination a", function (e){
					...
					$("#data").load("admin@dashop/home.php",{"page":page}, function(){ //get content from PHP page
						$(".loading-div").hide(); //once done, hide loading element
					});
				});
			});
			$(document).ready(function() {
				$("#data1" ).load( "admin@dashop/online.php"); //load initial records
				...
				$("#data1").on( "click", ".pagination a", function (e){
					...
					var page = $(this).attr("data-page"); //get page number from link
					$("#data1").load("admin@dashop/online.php",{"page":page}, function(){ //get content from PHP page
						$(".loading-div").hide(); //once done, hide loading element
					});
	...
	<body id="admin@admin">
		<div id="main1">
			...
			<div id="main_container">
				<?php include("admin@dashop/adminhome.php");?>
