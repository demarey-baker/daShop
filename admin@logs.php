	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$("#data" ).load( "admin@dashop/userlogs.php"); //load initial records
				...
				$("#data").on( "click", ".pagination a", function (e){
					...
					$("#data").load("admin@dashop/userlogs.php",{"page":page}, function(){ //get content from PHP page
			...
			$(document).ready(function() {
				$("#data1" ).load( "admin@dashop/activitylogs.php"); //load initial records
				
				//executes code below when user click on pagination links
				$("#data1").on( "click", ".pagination a", function (e){
					e.preventDefault();
					$(".loading-div").show(); //show loading element
					$("html, body").animate({ scrollTop: 373 }, "slow");
					var page = $(this).attr("data-page"); //get page number from link
					$("#data1").load("admin@dashop/activitylogs.php",{"page":page}, function(){ //get content from PHP page
						$(".loading-div").hide(); //once done, hide loading element
					});
	...
	<body id="adminlogs">
		<div id="main1">
			...
			<div id="main_container">
				<?php include("admin@dashop/adminlogs.php");?>
